...
| **실내 홈캠 객체 위치 추론 파이프라인 고도화** (사내 R&D) | VLM → 규칙기반 엔진 → SAM2 트래킹으로 검수 오류 빈도 감소, REACT++(Scene Graph Generation) 파인튜닝 비교 실험 | 단독 개발 (규칙엔진 설계·SAM2 트래킹 툴·REACT++ 비교) | [바로가기](docs/project_d_location_pipeline.md) |
